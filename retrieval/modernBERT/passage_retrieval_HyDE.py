...
def main(args):
    ...
    if args.dataset == 'ms_marco':
        ...
        # args.passages_path = '/data/QL_dataset
    ...
    # args.data_path = '/data/hyde_retrieval_1_rewrite_docs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, 
                        default='/data/HyDE', help="Results are written to outputdir with data suffix")
    parser.add_argument("--data_path", type=str,
                        default='/data/hyde_docs', help='path to QA dataset')
