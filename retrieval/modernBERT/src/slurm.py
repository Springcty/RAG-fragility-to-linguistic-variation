...
def init_distributed_mode(params):
    ...
    if is_slurm_job and has_local_rank:
        ...
        # update shard_id and num_shards
        params.shard_id = params.global_rank
        params.num_shards = params.world_size
...
def finalize_distributed_mode():
    """
    Finalize the distributed process group.
    """
    if torch.distributed.is_initialized():
        # Specify device IDs in barrier() to avoid potential hangs
