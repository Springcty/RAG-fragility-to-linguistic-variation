...
class Indexer(object):
    ...
    # def __init__(self, embedding_dim, nlist, m, nbits=8):
    #     if m > 0:
    #         coarse_quantizer = faiss.IndexFlatL2(embedding_dim) # is used to assign each vector to a cluster during indexing
    #         self.index = faiss.IndexIVFPQ(
    #             coarse_quantizer,   # the clustering index
    #             embedding_dim,      # embedding dimension
    #             nlist,              # number of centroid clusters
    #             m,                  # number of sub-vectors of product quantization
